...
{
  std::cout << "Delayed Interest with id: " << id << ", generated by: " << m_userPrefix << "\n";
...
ChronoSync::printData(const shared_ptr<const Data>& data)
{
  ...
  std::cout << "Data received by: " << m_userPrefix << ", from " << peerName.toUri() << " : " <<  s << "\n";
}
...
{
  std::cout << "Process Sync Update by: " << m_userPrefix << "\n";
  if (updates.empty()) {
    return;
  }
...
{
  std::cout << "ChronoSync Instance Initialized for: " << m_userPrefix << "\n";
